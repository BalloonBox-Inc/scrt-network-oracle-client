...
export default function Footer() {
  ...
  return (
    <footer
      className={`z-50 border-t-2 border-gray-800 w-full p-5 flex flex-row justify-between items-end bg-black text-white bg-cover font-sans ${
        routerIsMain ? 'bg-footer-wave' : undefined
      }`}
    >
      <div>
        <div>
