        ...
        <div className="w-full text-center">
          <div className=" flex flex-col items-center space-y-6  justify-center w-full">
            <div className="z-30 opacity-100 px-0 sm:p-10">
              <h2 className="z-30 font-semibold text-2xl sm:text-3xl md:text-3xl lg:text-4xl p-0">
                Choose a Service
              </h2>
              <p className="z-30 font-thin text-md sm:text-lg md:text-xl lg:text-2xl p-0">
                User Type: Applicant
              </p>
            </div>
